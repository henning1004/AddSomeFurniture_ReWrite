...
public class SimpleTableDesign extends GenericBlockDesign
{
	...
	public SimpleTableDesign(Main plugin, int[] textureids) {
		...
		part2p1.addVertex(3, 1F, 1F, 1F);
		part2p1.addVertex(0, 1F, 0.875F, 1F);
		part2p1.addVertex(1, 1F, 0.875F, 0F);
		part2p1.addVertex(2, 1F, 1F, 0F);
		...
		part2p3.addVertex(3, 0F, 1F, 0F);
		part2p3.addVertex(0, 0F, 0.875F, 0F);
		part2p3.addVertex(1, 0F, 0.875F, 1F);
		part2p3.addVertex(2, 0F, 1F, 1F);
