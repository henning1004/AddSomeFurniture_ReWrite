...
{
	public PsychoThroneDesign(Main plugin, int[] textureids){
		
		texture = RegisterTextures.texThrone;;
		setBoundingBox(0.1F,0,0.1F,0.9F,1.8F,0.9F).setQuadNumber(35);
		...
		backs1.addVertex(2, 0.1F, 1.8F, 0.225F);
		backs1.addVertex(1, 0.9F, 1.8F, 0.225F);
		backs1.addVertex(0, 0.9F, 0.625F, 0.225F);
		Quad backs2 = new Quad(23, subTex3);
		backs2.addVertex(0, 0.1F, 0.625F, 0.1F);
		backs2.addVertex(1, 0.1F, 1.8F, 0.1F);
		backs2.addVertex(2, 0.9F, 1.8F, 0.1F);
		...
		backs3.addVertex(1, 0.9F, 1.8F, 0.225F);
		backs3.addVertex(0, 0.9F, 1.8F, 0.1F);
		Quad backs4 = new Quad(25, subTex4);
		backs4.addVertex(0, 0.1F, 0.625F, 0.1F);
		backs4.addVertex(1, 0.1F, 0.625F, 0.225F);
		backs4.addVertex(2, 0.1F, 1.8F, 0.225F);
		backs4.addVertex(3, 0.1F, 1.8F, 0.1F);
		Quad backT = new Quad(26, subTex5);
		backT.addVertex(0, 0.1F, 1.8F, 0.1F);
		backT.addVertex(1, 0.1F, 1.8F, 0.225F);
		backT.addVertex(2, 0.9F, 1.8F, 0.225F);
		backT.addVertex(3, 0.9F, 1.8F, 0.1F);
		
		Quad arm1s1 = new Quad(27, subTex4);
		arm1s1.addVertex(3, 0.1F, 0.625F, 0.9F);
		arm1s1.addVertex(2, 0.1F, 1.0F, 0.9F);
		arm1s1.addVertex(1, 0.225F, 1.0F, 0.9F);
		arm1s1.addVertex(0, 0.225F, 0.625F, 0.9F);
		Quad arm1s2 = new Quad(28, subTex4);
		arm1s2.addVertex(3, 0.1F, 0.625F, 0.225F);
		arm1s2.addVertex(2, 0.1F, 1.0F, 0.225F);
		arm1s2.addVertex(1, 0.1F, 1.0F, 0.9F);
		arm1s2.addVertex(0, 0.1F, 0.625F, 0.9F);
		Quad arm1s3 = new Quad(29, subTex4);
		arm1s3.addVertex(0, 0.225F, 0.625F, 0.9F);
		arm1s3.addVertex(1, 0.225F, 0.625F, 0.225F);
		arm1s3.addVertex(2, 0.225F, 1.0F, 0.225F);
		arm1s3.addVertex(3, 0.225F, 1.0F, 0.9F);
		Quad arm1T = new Quad(30, subTex5);
		arm1T.addVertex(0, 0.1F, 1.0F, 0.225F);
		arm1T.addVertex(1, 0.1F, 1.0F, 0.9F);
		arm1T.addVertex(2, 0.225F, 1.0F, 0.9F);
		arm1T.addVertex(3, 0.225F, 1.0F, 0.225F);
		
		Quad arm2s1 = new Quad(31, subTex4);
		arm2s1.addVertex(3, 0.775F, 0.625F, 0.9F);
		arm2s1.addVertex(2, 0.775F, 1.0F, 0.9F);
		arm2s1.addVertex(1, 0.9F, 1.0F, 0.9F);
		arm2s1.addVertex(0, 0.9F, 0.625F, 0.9F);
		Quad arm2s2 = new Quad(32, subTex4);
		arm2s2.addVertex(3, 0.775F, 0.625F, 0.225F);
		arm2s2.addVertex(2, 0.775F, 1.0F, 0.225F);
		arm2s2.addVertex(1, 0.775F, 1.0F, 0.9F);
		arm2s2.addVertex(0, 0.775F, 0.625F, 0.9F);
		Quad arm2s3 = new Quad(33, subTex4);
		arm2s3.addVertex(0, 0.9F, 0.625F, 0.9F);
		arm2s3.addVertex(1, 0.9F, 0.625F, 0.225F);
		arm2s3.addVertex(2, 0.9F, 1.0F, 0.225F);
		arm2s3.addVertex(3, 0.9F, 1.0F, 0.9F);
		Quad arm2T = new Quad(34, subTex5);
		arm2T.addVertex(0, 0.775F, 1.0F, 0.225F);
		arm2T.addVertex(1, 0.775F, 1.0F, 0.9F);
		arm2T.addVertex(2, 0.9F, 1.0F, 0.9F);
		arm2T.addVertex(3, 0.9F, 1.0F, 0.225F);
