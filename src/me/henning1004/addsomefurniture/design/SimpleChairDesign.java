...
public class SimpleChairDesign extends GenericBlockDesign 
{
	...
	public SimpleChairDesign(Main plugin, int[] textureids) {
		...
		part3p1.addVertex(1, 0.4375F, 0.5625F, 0.25F);
		part3p1.addVertex(2, 0.4375F, 0F, 0F);
		part3p1.addVertex(3, 0.4375F, 0F, 0.125F);
		part3p1.addVertex(0, 0.4375F, 0.5625F, 0.375F);
		...
		part3p3.addVertex(1, 0.5625F, 0.5625F, 0.375F);
		part3p3.addVertex(2, 0.5625F, 0F, 0.125F);
		part3p3.addVertex(3, 0.5625F, 0F, 0F);
		part3p3.addVertex(0, 0.5625F, 0.5625F, 0.25F);
		...
		part3p5.addVertex(1, 0.25F, 0.5625F, 0.625F);
		part3p5.addVertex(2, 0F, 0F, 0.875F);
		part3p5.addVertex(3, 0F, 0F, 1F);
		part3p5.addVertex(0, 0.25F, 0.5625F, 0.75F);
		...
		part3p7.addVertex(1, 0.375F, 0.5625F, 0.75F);
		part3p7.addVertex(2, 0.125F, 0F, 1F);
		part3p7.addVertex(3, 0.125F, 0F, 0.875F);
		part3p7.addVertex(0, 0.375F, 0.5625F, 0.625F);
		...
		part3p9.addVertex(1, 0.75F, 0.5625F, 0.75F);
		part3p9.addVertex(2, 1F, 0F, 1F);
		part3p9.addVertex(3, 1F, 0F, 0.875F);
		part3p9.addVertex(0, 0.75F, 0.5625F, 0.625F);
		...
		part3p12.addVertex(1, 0.625F, 0.5625F, 0.625F);
		part3p12.addVertex(2, 0.875F, 0F, 0.875F);
		part3p12.addVertex(3, 0.875F, 0F, 1F);
		part3p12.addVertex(0, 0.625F, 0.5625F, 0.75F);
