...
{
	public BarstoolDesign(Main plugin, int[] textureids) {
	...
	part2p2.addVertex(1, 0.1875F, 1F, 0.1875F);
	part2p2.addVertex(2, 0.1875F, 0.875F, 0.1875F);
	part2p2.addVertex(3, 0.1875F, 0.875F, 0.8125F);
	part2p2.addVertex(0, 0.1875F, 1F, 0.8125F);
	setLightSource(3, 1, 0, 0);

	
	Quad part2p3 = new Quad(4, subTex2);
	part2p3.addVertex(1, 0.8125F, 1F, 0.8125F);
	part2p3.addVertex(2, 0.8125F, 0.875F, 0.8125F);
	part2p3.addVertex(3, 0.8125F, 0.875F, 0.1875F);
	part2p3.addVertex(0, 0.8125F, 1F, 0.1875F);
	...
	part5p2.addVertex(1, 0.4375F, 0.875F, 0.4375F);
	part5p2.addVertex(2, 0.4375F, 0.0625F, 0.4375F);
	part5p2.addVertex(3, 0.4375F, 0.0625F, 0.5625F);
	part5p2.addVertex(0, 0.4375F, 0.875F, 0.5625F);
	...
	part5p4.addVertex(1, 0.5625F, 0.875F, 0.5625F);
	part5p4.addVertex(2, 0.5625F, 0.0625F, 0.5625F);
	part5p4.addVertex(3, 0.5625F, 0.0625F, 0.4375F);
	part5p4.addVertex(0, 0.5625F, 0.875F, 0.4375F);
